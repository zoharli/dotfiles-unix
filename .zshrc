...
alias k1='ssh lzh@219.223.194.161'
export K1=lzh@219.223.194.161
alias lnn='ssh lzh@219.223.192.117'
export LNN=lzh@219.223.192.117
...
alias m10='ssh lzh@192.168.6.157'
export M10=lzh@192.168.6.157
...
alias py='python'
alias lt='l -t'
alias ps='ps -eo pid,tty,user,comm,lstart,pcpu,%mem'
